...
void printUsageAndExit() {
  printf("%s", "Usage: ./eigeneigensolver [-help] [-mode [hDDI | hDFI | hFFI | "
               "dDDI | dDFI | dFFI] [-m mformat mfile] [-c config_file]\n");
  ...
  printf(
      "%s",
      "     -c set the amg eigensolver options from the configuration file\n");
